...
# Ensure nexa-model absolute path
nexa_path = Path("/app/applet/nexa-model")
if nexa_path.exists() and str(nexa_path) not in sys.path:
    sys.path.insert(0, str(nexa_path))
