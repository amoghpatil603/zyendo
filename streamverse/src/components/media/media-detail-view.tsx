...
const TrailerEmbed = dynamic(() => import("./trailer-embed").then(m => m.TrailerEmbed));
        ...
        <PageContainer className="relative -mt-40 sm:-mt-48">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              <h1 className="break-words text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
                {detail.title}
              </h1>
      ...
      <PageContainer className="space-y-10">
        {detail.synopsis ? (
          <section className="space-y-2">
            ...
            <p className="max-w-3xl text-base/relaxed sm:text-lg/relaxed text-muted-foreground">
              {detail.synopsis}
            </p>
          </section>
        ) : null}
